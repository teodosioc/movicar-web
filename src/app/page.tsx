  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      <section className="relative overflow-hidden bg-zinc-50">
        ...
        <div className="absolute inset-y-0 right-0 hidden w-1/2 bg-[radial-gradient(circle_at_top_right,rgba(220,38,38,0.07),transparent_45%)] lg:block" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 sm:py-14 lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-8 lg:py-20">
          ...
          <div className="order-1 lg:order-2">
            <div className="mx-auto w-full max-w-[420px] sm:max-w-[460px] lg:max-w-[500px]">
              <div className="relative mx-auto rounded-[34px] border border-zinc-200/80 bg-white p-3 shadow-[0_30px_80px_rgba(24,24,27,0.14)] sm:rounded-[40px] sm:p-4">
                <div className="rounded-[28px] bg-zinc-950 p-2.5 sm:rounded-[34px] sm:p-3">
                  <div className="overflow-hidden rounded-[22px] bg-zinc-50 sm:rounded-[28px]">
                    <div className="flex items-center justify-between border-b border-zinc-200 bg-white px-3 py-3 sm:px-4">
                      <div className="flex min-w-0 items-center gap-2">
                        <MoviCarIconOnly className="h-7 w-7 shrink-0" />
                        <div className="min-w-0">
                          <p className="truncate text-sm font-bold text-zinc-900 sm:text-[15px]">
                            Nova vistoria
                          </p>
                    ...
                    <div className="p-3 sm:p-4">
                      <div className="mb-4 overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-200 shadow-sm">
                        <div className="relative w-full">
                          ...
                          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/45 to-transparent p-3 sm:p-4">
                            <div className="inline-flex rounded-xl bg-black/35 px-3 py-1.5 backdrop-blur-[1px]">
                      ...
                      <div className="grid gap-3">
                        <div className="rounded-2xl border border-zinc-200 bg-zinc-100/80 p-4">
                          <p className="text-sm font-semibold text-zinc-800 sm:text-[15px]">
                            Checklist da etapa
                          </p>
                        ...
                        <button
                          type="button"
                          className="w-full rounded-2xl bg-red-600 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-red-700 sm:text-base"
                        >
                          Próximo passo
                        </button>
                      </div>
...
function MockLine({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-2 text-sm text-zinc-600 sm:text-[15px]">
...
function MiniFeature({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-3 text-center shadow-sm">
